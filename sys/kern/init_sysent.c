...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(cheri_cidcap_alloc_args), .sy_call = (sy_call_t *)sys_cheri_cidcap_alloc, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 91 = cheri_cidcap_alloc */
